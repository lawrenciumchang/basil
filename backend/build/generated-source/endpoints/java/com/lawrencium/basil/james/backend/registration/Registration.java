 ...
 * on 2015-05-08 at 20:36:39 UTC 
 * Modify at your own risk.
 */

package com.lawrencium.basil.james.backend.registration;
...
public class Registration extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "isRegistered".
   *
   * This request holds the parameters needed by the registration server.  After setting any optional
   * parameters, call the {@link IsRegistered#execute()} method to invoke the remote operation.
   *
   * @param regId
   * @return the request
   */
  public IsRegistered isRegistered(java.lang.String regId) throws java.io.IOException {
    IsRegistered result = new IsRegistered(regId);
    initialize(result);
    return result;
  }

  public class IsRegistered extends RegistrationRequest<com.lawrencium.basil.james.backend.registration.model.RegistrationRecord> {

    private static final String REST_PATH = "isRegistered/{regId}";

    /**
     * Create a request for the method "isRegistered".
     *
     * This request holds the parameters needed by the the registration server.  After setting any
     * optional parameters, call the {@link IsRegistered#execute()} method to invoke the remote
     * operation. <p> {@link
     * IsRegistered#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @param regId
     * @since 1.13
     */
    protected IsRegistered(java.lang.String regId) {
      super(Registration.this, "POST", REST_PATH, null, com.lawrencium.basil.james.backend.registration.model.RegistrationRecord.class);
      this.regId = com.google.api.client.util.Preconditions.checkNotNull(regId, "Required parameter regId must be specified.");
    }

    @Override
    public IsRegistered setAlt(java.lang.String alt) {
      return (IsRegistered) super.setAlt(alt);
    }

    @Override
    public IsRegistered setFields(java.lang.String fields) {
      return (IsRegistered) super.setFields(fields);
    }

    @Override
    public IsRegistered setKey(java.lang.String key) {
      return (IsRegistered) super.setKey(key);
    }

    @Override
    public IsRegistered setOauthToken(java.lang.String oauthToken) {
      return (IsRegistered) super.setOauthToken(oauthToken);
    }

    @Override
    public IsRegistered setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (IsRegistered) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public IsRegistered setQuotaUser(java.lang.String quotaUser) {
      return (IsRegistered) super.setQuotaUser(quotaUser);
    }

    @Override
    public IsRegistered setUserIp(java.lang.String userIp) {
      return (IsRegistered) super.setUserIp(userIp);
    }
    ...
    public IsRegistered setRegId(java.lang.String regId) {
      this.regId = regId;
      return this;
    }

    @Override
    public IsRegistered set(String parameterName, Object value) {
      return (IsRegistered) super.set(parameterName, value);
    }
  }
  ...
  public class ListDevices extends RegistrationRequest<com.lawrencium.basil.james.backend.registration.model.CollectionResponseRegistrationRecord> {
    ...
    protected ListDevices(java.lang.Integer count) {
      super(Registration.this, "GET", REST_PATH, null, com.lawrencium.basil.james.backend.registration.model.CollectionResponseRegistrationRecord.class);
   ...
   * @return the request
   */
  public ListFriends listFriends() throws java.io.IOException {
    ListFriends result = new ListFriends();
    initialize(result);
    return result;
  }

  public class ListFriends extends RegistrationRequest<com.lawrencium.basil.james.backend.registration.model.CollectionResponseStringCollection> {
     ...
     * @since 1.13
     */
    protected ListFriends() {
      super(Registration.this, "GET", REST_PATH, null, com.lawrencium.basil.james.backend.registration.model.CollectionResponseStringCollection.class);
    }
   ...
   * @return the request
   */
  public Register register(java.lang.String regId, java.lang.String userName, java.lang.String emailAddress) throws java.io.IOException {
    Register result = new Register(regId, userName, emailAddress);
    initialize(result);
    return result;
  }
  ...
  public class Register extends RegistrationRequest<Void> {
    ...
    private static final String REST_PATH = "registerDevice/{regId}/{userName}/{emailAddress}";
     ...
     * @since 1.13
     */
    protected Register(java.lang.String regId, java.lang.String userName, java.lang.String emailAddress) {
    ...
    public Register setEmailAddress(java.lang.String emailAddress) {
