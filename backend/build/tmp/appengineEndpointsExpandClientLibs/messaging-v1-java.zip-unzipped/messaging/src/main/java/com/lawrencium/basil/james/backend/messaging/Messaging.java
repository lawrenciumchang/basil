 ...
 * on 2015-05-08 at 20:36:40 UTC 
 * Modify at your own risk.
 */

package com.lawrencium.basil.james.backend.messaging;
...
public class Messaging extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class MessagingEndpoint {
     ...
     * @return the request
     */
    public SendMessage sendMessage(java.lang.String message, java.lang.String recipient) throws java.io.IOException {
      SendMessage result = new SendMessage(message, recipient);
      initialize(result);
      return result;
    }
    ...
    public class SendMessage extends MessagingRequest<Void> {
      ...
      private static final String REST_PATH = "{message}/{recipient}";
       ...
       * @since 1.13
       */
      protected SendMessage(java.lang.String message, java.lang.String recipient) {
      ...
      public SendMessage setRecipient(java.lang.String recipient) {
